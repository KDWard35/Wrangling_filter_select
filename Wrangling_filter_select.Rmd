...
```
The comedies with with an MPAA rating, over 120 minutes have a rating above 8 are Big Fish, Forrest Gump, O Homem Que Copiava, and The Incredibles.
...
```
The movies included in this data are Harry Potter and the Chamber of Secrets, Harry Potter and the Prisoner of Azkaban, and Harry Potter and the Sorcerer's Stone. The highest rated with a score of 7.8, is Harry Potter and the Prisoner of Azkaban. The one with the most votes, 46741, was Harry Potter and the Sorcerer's Stone.
4. What is the highest budget for a movie that is an Animation or Comedy with at least 100 votes?

```{r}
movies %>%
  filter(Comedy == 1|Animation == 1,votes>99) %>%
  arrange(desc(budget))
```
The highest budget for a comedy or animation was $170,000,000, for Wild Wild West.
